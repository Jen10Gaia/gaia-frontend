...
const Header = () => {
  // We use the sate here to diplay user in the header
  ...
  return (
    <div className="">
      <nav className="navbar navbar-light bg-custom-1 navbar-expand-lg justify-content-between px-5 py-4 rounded nav-custom" >
