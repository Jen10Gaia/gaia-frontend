              ...
              stats && (
                <>
                  ...
                  <div className="alert alert-danger mt-4">
                    <b>Note:</b> These statistics are collected from the services that
                    are posted only on Global Access Immigration Agency (GAIA). They are not to be compared with
                    other sites.
                  </div>
                </>
              )
